        ...
        return (
          <>
            ...
            <Row>
                ...
                <Container className="d-flex flex-column justify-content-start align-items-center mt-5 mb-5 text-center ">
                  <Image src={data.images} width={1000} height={500} className='rounded'></Image>

  ...
  return (
    <div>
      ...
      <Container>
        ...
        <Row className="mb-3">
          <Col md={12} className="p-0 image-container">

              <Image src={HotelImage} width="100%"  height ="700px" className="img" style={{marginTop:'-100px'}}></Image>
          </Col>
        </Row>
        ...
        <Row className="mb-3 images">
          <Col md={8} className="p-0 image-container">
            ...
            <Image src={rooms} width="100%" height="500px" className="img"></Image>

          </Col>

          <Col md={4} className="bg-success d-flex flex-column justify-content-center align-items-center text-justify" >
            <text className="text-white" style={{ fontSize: '21px' , width:'90%' }}>Welcome to The Lake Hotels, where luxury meets tranquility. Immerse yourself in a serene oasis nestled by picturesque lakes, offering a seamless blend of comfort and sophistication.</text>
        ...
        <Row className="mb-3">
          ...
          <Col md={8} className="p-0 image-container">
            <Image src={temple} width="100%" height="500px" className="img" ></Image>
          </Col>
        </Row>
        ...
        <Row className="mb-3">
          <Col md={8} className="p-0 image-container">
            ...
            <Image src={RabindraLake} width="100%" height="500px" className="img"></Image>
          </Col>
        ...
        <Row className="mb-3">
          ...
          <Col md={8} className="p-0 image-container">
            <Image src={VaayuCafe} width="100%" height="500px" className="img"></Image>
          </Col>
        </Row>
